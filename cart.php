...
<section class="products shopping-cart">
   ...
   <form action="" method="post" class="box">
      ...
      <input type="submit" value="DELETE" onclick="return confirm('YOU SURE?');" class="delete-btn" name="delete">
   </form>
   <?php
   $grand_total += $sub_total;
      }
   }else{
      echo '<p class="empty">ITS SO LONELY HERE</p>';
   }
   ?>
   </div>
   ...
   <div class="cart-total">
      ...
      <a href="cart.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('YOU SURE?');">DELETE ALL</a>
