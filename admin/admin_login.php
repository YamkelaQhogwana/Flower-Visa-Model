...
/*Connect Compinent Included In Order To Avoid Repeating Lines Of Code (DRY)*/
...
<head>
   ...
   <title>FLOWER VISA ADMIN LOGIN</title>
...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>ADMIN LOGIN</h3>
      <p>REFER TO DOCUMENTATION FOR PASSWORD AND USERNAME</p>
